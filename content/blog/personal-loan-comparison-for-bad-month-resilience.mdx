...
- If consolidating cards, pair the loan with a written spending cap and use the [credit card APR cost guide](/blog/credit-card-apr-what-it-actually-costs) to quantify relapse risk.
...
Pair with [Debt-to-Income 90-Day Plan](/blog/debt-to-income-ratio-90-day-plan) and [Credit Card APR Cost Guide](/blog/credit-card-apr-what-it-actually-costs).
