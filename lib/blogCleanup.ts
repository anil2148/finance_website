...
const legacySlugFallbacks: Array<{ pattern: RegExp; destination: string; reason: RedirectItem['reason'] }> = [
  { pattern: /^seo-401k-contribution-rate-guide-2026$/i, destination: '/blog/401k-contribution-rate-playbook-2026', reason: 'MERGE' },
  { pattern: /^seo-zero-based-budget-monthly-system$/i, destination: '/blog/zero-based-budget-monthly-control-system', reason: 'MERGE' },
  { pattern: /^seo-credit-card-apr-2026-cost-to-carry-balance$/i, destination: '/blog/credit-card-apr-2026-real-balance-cost', reason: 'MERGE' },
  ...
  { pattern: /^budgeting-guide-\d+$/i, destination: '/blog/50-30-20-rule-decision-based', reason: 'REDIRECT' },
