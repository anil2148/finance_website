...
export const AUTHOR_PROFILES: Record<string, AuthorProfile> = {
  [PRIMARY_AUTHOR_ID]: {
    ...
    bio: 'Smita built FinanceSphere after seeing how often people make high-cost decisions with partial information. The platform combines concrete math, comparison filters, and plain-language guidance so readers can move from uncertainty to a documented next step.'
  },
