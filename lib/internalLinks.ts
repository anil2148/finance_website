...
const categoryLinks: Record<string, RelatedLink[]> = {
  investing: [
    ...
    { label: 'Tax-efficient investing rules', href: '/blog/tax-efficient-investing-playbook', type: 'article' }
  ],
  'credit-cards': [
  ...
  budgeting: [
    ...
    { label: 'Emergency fund target method', href: '/blog/emergency-fund-by-recovery-timeline', type: 'article' }
  ],
  savings: [
    { label: 'Budgeting hub', href: '/learn/budgeting', type: 'hub' },
    { label: 'Best savings accounts', href: '/best-savings-accounts-usa', type: 'comparison' },
