...
const categoryLinks: Record<string, RelatedLink[]> = {
  investing: [
    ...
    { label: 'Tax-efficient investing rules', href: '/blog/tax-efficient-investing-account-location-playbook', type: 'article' }
  ],
  'credit-cards': [
  ...
  mortgages: [
    ...
    { label: 'Mortgage preapproval checklist', href: '/blog/mortgage-preapproval-checklist', type: 'article' }
  ],
  budgeting: [
    ...
    { label: 'Emergency fund target method', href: '/blog/emergency-fund-target-by-recovery-time', type: 'article' }
  ],
  savings: [
    { label: 'Budgeting hub', href: '/learn/budgeting', type: 'hub' },
    { label: 'Best savings accounts', href: '/best-savings-accounts-usa', type: 'comparison' },
