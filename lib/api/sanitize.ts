 ...
 * - Removes ASCII control characters (except tab 0x09, LF 0x0A, CR 0x0D) that could
 *   confuse LLM tokenisers or act as hidden prompt-injection sequences.
 *   DEL (0x7F) is also stripped: it is a non-printable control character that falls
 *   outside the standard 0x00–0x1F range but should still be removed.
