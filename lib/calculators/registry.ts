...
const rawCalculatorDefinitions: CalculatorDefinition[] = [
  {
    ...
    faq: [
      ...
      { question: 'Does this include taxes and insurance?', answer: 'Estimated Total Monthly Cost includes P&I, property tax, homeowners insurance, and PMI. Monthly P&I and Total Paid (P&I) intentionally cover principal-and-interest cashflows only so assumptions stay explicit.' }
    ],
    blogLinks: [
