...
const rawCalculatorDefinitions: CalculatorDefinition[] = [
  {
    ...
    faq: [
      ...
      { question: 'Does this include taxes and insurance?', answer: 'Yes. Monthly P&I is shown separately, and Estimated Total Monthly Cost adds property tax, homeowners insurance, and PMI. Total Paid (P&I) intentionally excludes those escrow-like costs.' }
    ],
    blogLinks: [
