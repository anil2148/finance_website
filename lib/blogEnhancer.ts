...
function inferBlueprint(topic: string): TopicBlueprint {
  ...
  if (topic.includes('invest') || topic.includes('retirement') || topic.includes('dividend') || topic.includes('asset')) {
    return {
      ...
      links: {
        ...
        related: { label: 'Dollar-cost averaging guide', href: '/blog/investing-for-beginners-roadmap' }
      },
      titleTemplates: [
  ...
  if (topic.includes('tax')) {
    return {
      ...
      links: {
        ...
        hub: { label: 'Investing hub', href: '/learn/investing' },
        related: { label: 'Roth vs Traditional IRA', href: '/blog/tax-efficient-investing-playbook' }
      },
      titleTemplates: [
  ...
  if (topic.includes('budget') || topic.includes('save') || topic.includes('emergency')) {
    return {
      ...
      links: {
        ...
        related: { label: 'Emergency fund guide', href: '/blog/emergency-fund-by-recovery-timeline' }
      },
      titleTemplates: [
  ...
  return {
    ...
    links: {
      ...
      comparison: { label: 'Best savings accounts', href: '/best-savings-accounts-usa' },
      hub: { label: 'Budgeting hub', href: '/learn/budgeting' },
      related: { label: 'Automate your savings plan', href: '/blog/emergency-fund-by-recovery-timeline' }
    },
