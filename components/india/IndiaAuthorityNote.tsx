...
export function IndiaAuthorityNote() {
  ...
  return (
    <section className="mt-8 rounded-xl border border-slate-200 bg-slate-50 p-5 dark:border-slate-700 dark:bg-slate-900" aria-label="About the author">
      <div className="mb-3 rounded-lg border border-blue-200 bg-blue-50/70 px-3 py-2 text-xs font-semibold text-blue-800 dark:border-blue-400/30 dark:bg-blue-500/10 dark:text-blue-200">
      ...
      <div className="mt-4 flex flex-wrap gap-3 border-t border-slate-200 pt-3 text-xs dark:border-slate-700">
        ...
        <AppLink variant="editorial" href="https://www.rbi.org.in/" target="_blank" rel="noreferrer" className="font-medium">RBI</AppLink>
        <AppLink variant="editorial" href="https://incometaxindia.gov.in/" target="_blank" rel="noreferrer" className="font-medium">Income Tax India</AppLink>
      </div>
    </section>
  );
}
