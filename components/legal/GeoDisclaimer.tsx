...
export function GeoDisclaimer() {
  ...
  return (
    <aside className="mx-auto mt-4 max-w-7xl rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-900">
      ...
      <p className="mt-1">
        FinanceSphere content is educational and localized for {config.label}. Terminology on this view follows {terms.accounting_standard}, {terms.tax_authority}, and {terms.tax_framework}. Verify final compliance with a licensed advisor in your jurisdiction.
      </p>
    </aside>
  );
}
