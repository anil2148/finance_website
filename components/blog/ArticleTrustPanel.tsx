    ...
    <aside className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
      ...
      <div className="mt-3 space-y-3">
        ...
        <p className="text-xs text-slate-600">
          ...
          <AppLink href="/financial-disclaimer" variant="utility" className="ml-1">Read disclaimer</AppLink>
        </p>

        <div className="flex flex-wrap gap-2 text-xs">
          <AppLink href="/editorial-policy" variant="chip" className="border-slate-300 bg-white px-2 py-1">Editorial policy</AppLink>
          <AppLink href="/how-we-make-money" variant="chip" className="border-slate-300 bg-white px-2 py-1">How we make money</AppLink>
        </div>
      </div>
    </aside>
  );
