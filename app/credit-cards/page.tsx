    ...
    <section className="space-y-6">
      <header className="space-y-3 rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <div className="flex flex-wrap gap-2 text-sm">
          ...
          <Link href="/blog/seo-credit-card-apr-2026-what-your-rate-costs" className="rounded-full border border-slate-300 px-3 py-1 font-medium text-slate-700 hover:border-blue-300 hover:text-blue-700">APR cost guide</Link>
        </div>
      </header>
