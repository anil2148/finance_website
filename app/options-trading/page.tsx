    ...
    <article className="space-y-10">
      ...
      <section className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <div className="flex flex-wrap gap-2 text-sm">
          <Link href="/blog/beginner-investing-roadmap-year-one-milestones" className="rounded-full border border-slate-300 px-3 py-1 hover:bg-slate-100">Investing roadmap</Link>
          <Link href="/blog/beginner-investing-roadmap-year-one-milestones" className="rounded-full border border-slate-300 px-3 py-1 hover:bg-slate-100">Avoid common mistakes</Link>
          <Link href="/blog/beginner-investing-roadmap-year-one-milestones" className="rounded-full border border-slate-300 px-3 py-1 hover:bg-slate-100">Volatility playbook</Link>
        </div>
      </section>
