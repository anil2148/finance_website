...
const useCases = [
  {
    ...
    nextStep: '/blog/beginner-investing-roadmap-year-one-milestones'
  },
  {
    audience: 'Students',
  ...
  },
  {
    ...
    nextStep: '/blog/tax-efficient-investing-account-location-decisions'
  },
  {
        ...
        <div className="grid gap-6 md:grid-cols-[1.25fr_1fr] md:items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link href="/blog/beginner-investing-roadmap-year-one-milestones" className="inline-flex items-center justify-center rounded-xl border border-blue-200 px-4 py-2 font-medium text-white transition hover:bg-white/10">
