...
export default function SipStrategyIndiaPage() {
  return (
    <article className="space-y-6">
      ...
      <section className="rounded-2xl border bg-white p-6"><div className="flex flex-wrap gap-3 text-sm"><Link href="/in/investing">Investing hub</Link><Link href="/in/fixed-deposit-vs-sip-india">FD vs SIP comparison</Link><Link href="/in/best-investment-apps-india">Investment apps comparison</Link><Link href="/in/calculators/sip-calculator">SIP calculator</Link><Link href="/in/tax">Tax hub</Link></div></section>
      <IndiaAuthorityNote />
    </article>
  );
}
