...
export default function SipStrategyIndiaPage() {
  return (
    <article className="space-y-6">
      ...
      <section className="rounded-2xl border bg-white p-6"><div className="india-link-cluster text-sm"><Link className="content-link-chip" href="/in/investing">Investing hub</Link><Link className="content-link-chip" href="/in/fixed-deposit-vs-sip-india">FD vs SIP comparison</Link><Link className="content-link-chip" href="/in/best-investment-apps-india">Investment apps comparison</Link><Link className="content-link-chip" href="/in/calculators/sip-calculator">SIP calculator</Link><Link className="content-link-chip" href="/in/tax">Tax hub</Link></div></section>
      <IndiaAuthorityNote />
    </article>
  );
}
