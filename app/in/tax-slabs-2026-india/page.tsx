  ...
  return (
    <article className="space-y-6">
      ...
      <section className="rounded-2xl border bg-white p-6 text-sm">
        ...
        <div className="mt-3 flex flex-wrap gap-3"><Link href="/in/tax">Tax hub</Link><Link href="/in/old-vs-new-tax-regime">Old vs new regime</Link><Link href="/in/80c-deductions-guide">80C guide</Link><Link href="/in/calculators/sip-calculator">SIP calculator</Link><Link href="/in/best-investment-apps-india">Investment apps comparison</Link></div>
      </section>
      <IndiaAuthorityNote />
    </article>
  );
