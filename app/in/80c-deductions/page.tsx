...
export default function DeductionsPage() {
  return (
    <article className="space-y-6">
      ...
      <section className="rounded-2xl border bg-white p-6"><div className="mt-3 flex flex-wrap gap-3 text-sm"><Link href="/in/tax-slabs" className="text-blue-700">Tax slabs</Link><Link href="/in/old-vs-new-tax-regime" className="text-blue-700">Old vs new regime</Link><Link href="/in/tax-saving-strategies" className="text-blue-700">Tax-saving strategies</Link><Link href="/in/calculators/sip-calculator" className="text-blue-700">SIP calculator</Link><Link href="/in/fixed-deposit-vs-sip-india" className="text-blue-700">FD vs SIP comparison</Link></div></section>
      <IndiaAuthorityNote />
    </article>
  );
}
