...
const title = 'GST Impact on EMI, Insurance & Mutual Fund Returns';
  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      breadcrumbSchema([
        ...
        { name: title, item: '/in/blog/gst-impact-on-finance' }
      ])
    ]
  };
  ...
  return (
    <>
      ...
      <IndiaArticleRenderer
        title="GST Impact on EMI, Insurance & Mutual Fund Returns"
        subtitle="Tax guide"
