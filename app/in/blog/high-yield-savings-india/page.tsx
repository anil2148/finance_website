...
const title = 'High-Yield Savings Accounts in India: Banks & Rates';
  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      breadcrumbSchema([
        ...
        { name: title, item: '/in/blog/high-yield-savings-india' }
      ])
    ]
  };
  ...
  return (
    <>
      ...
      <IndiaArticleRenderer
        title="High-Yield Savings Accounts in India: Banks & Rates"
