...
const title = 'Personal Loan vs Credit Card: Debt Stacking Strategy';
  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      breadcrumbSchema([
        ...
        { name: title, item: '/in/blog/personal-loan-vs-cc' }
      ])
    ]
  };
  ...
  return (
    <>
      ...
      <IndiaArticleRenderer
        title="Personal Loan vs Credit Card: Debt Stacking Strategy"
