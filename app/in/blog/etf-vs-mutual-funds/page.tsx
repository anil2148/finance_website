...
const title = 'ETF vs Mutual Funds in India: Fee & Tax Tradeoffs';
  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      breadcrumbSchema([
        ...
        { name: title, item: '/in/blog/etf-vs-mutual-funds' }
      ])
    ]
  };
  ...
  return (
    <>
      ...
      <IndiaArticleRenderer
        title="ETF vs Mutual Funds in India: Fee & Tax Tradeoffs"
