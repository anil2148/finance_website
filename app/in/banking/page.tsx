...
export default function BankingPage() {
  ...
  return (
    <section className="space-y-6">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-900">
        <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Failure simulation: stress-test before optimizing yields</h2>
        <div className="mt-3 overflow-x-auto">
          <table className="w-full min-w-[760px] text-left text-sm">
            ...
            <tbody>
              {failureSimulations.map((item) => (
                <tr key={item.scenario} className="border-b border-slate-100 align-top dark:border-slate-800">
                  <td className="px-3 py-2 font-medium text-slate-900 dark:text-slate-100">{item.scenario}</td>
                  <td className="px-3 py-2 text-slate-700 dark:text-slate-300">{item.failurePoint}</td>
                  <td className="px-3 py-2 text-slate-700 dark:text-slate-300">{item.consequence}</td>
                </tr>
              ))}
            </tbody>
          </table>
