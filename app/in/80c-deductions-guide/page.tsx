...
export default function DeductionsGuideIndiaPage() {
  return (
    <article className="space-y-6">
      ...
      <section className="rounded-2xl border bg-white p-6"><div className="flex flex-wrap gap-3 text-sm"><Link href="/in/tax">Tax hub</Link><Link href="/in/tax-slabs-2026-india">Tax slabs 2026</Link><Link href="/in/old-vs-new-tax-regime">Old vs new regime</Link><Link href="/in/blog/ppf-vs-elss">PPF vs ELSS</Link><Link href="/in/calculators/sip-calculator">SIP calculator</Link><Link href="/in/best-investment-apps-india">Investment apps comparison</Link></div></section>
      <IndiaAuthorityNote />
    </article>
  );
}
