...
export default function HomeAffordabilityIndiaPage() {
  return (
    <article className="space-y-6">
      ...
      <section className="rounded-2xl border bg-white p-6 text-sm"><p><strong>Biggest mistake to avoid:</strong> exhausting emergency corpus for down payment.</p><p className="mt-2"><strong>Best choice by scenario:</strong> keep 6–9 months expenses after down payment and registration costs.</p><div className="mt-3 flex flex-wrap gap-3"><Link href="/in/real-estate">Real-estate hub</Link><Link href="/in/rent-vs-buy-india">Rent vs buy comparison</Link><Link href="/in/home-loan-interest-rates-india">Home loan comparison</Link><Link href="/in/calculators/emi-calculator">EMI calculator</Link><Link href="/in/personal-loan-comparison-india">Personal loan comparison</Link></div></section>
      <IndiaAuthorityNote />
    </article>
  );
}
