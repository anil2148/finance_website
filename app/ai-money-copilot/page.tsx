  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No. AI Money Copilot uses rule-based calculations and structured financial logic — not a language model or AI API. All estimates are based on your inputs and clearly labeled assumptions like tax rates and mortgage rate assumptions.'
      }
    },
    {
      '@type': 'Question',
...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    description:
      'Receive a bottom-line recommendation, key financial metrics, what could change the answer, risks to watch for, and concrete next steps — all based on your inputs.'
  }
];
    ...
    <section className="space-y-10">
      ...
      <section className="rounded-3xl border border-amber-100 bg-amber-50/60 p-6 dark:border-amber-800/30 dark:bg-amber-950/20 md:p-8">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-3">
          <TrustPoint
            icon="📊"
            title="Rule-based calculations"
            body="All outputs are derived from stated formulas and assumptions — no opaque AI model."
          />
          <TrustPoint
            icon="🔒"
