...
const featuredGuides = [
  ...
  { href: '/blog/personal-loan-comparison-for-resilience', label: 'How to Compare Personal Loan APR' },
  { href: '/blog/personal-loan-comparison-for-resilience', label: 'Payment Resilience Loan Checklist' },
