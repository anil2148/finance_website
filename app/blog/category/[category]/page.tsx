...
const featuredOrderByCategory: Record<string, string[]> = {
  investing: ['beginner-investing-roadmap-year-one', 'tax-efficient-investing-account-location-playbook'],
  loans: ['mortgage-preapproval-checklist', 'personal-loan-comparison-for-resilience', 'debt-to-income-ratio-90-day-plan'],
  'credit-cards': ['credit-utilization-statement-cycle-playbook'],
  'savings-accounts': ['emergency-fund-target-by-recovery-time', 'how-to-choose-a-high-yield-savings-account', 'flex-budget-reset-rules']
};
