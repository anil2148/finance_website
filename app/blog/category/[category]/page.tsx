...
const featuredOrderByCategory: Record<string, string[]> = {
  investing: ['investing-for-beginners-roadmap', 'tax-efficient-investing-playbook'],
  loans: ['mortgage-preapproval-checklist', 'how-to-compare-personal-loan-apr', 'debt-to-income-ratio-90-day-plan'],
  'credit-cards': ['credit-utilization-statement-cycle-playbook'],
  'savings-accounts': ['emergency-fund-by-recovery-timeline', 'how-to-choose-a-high-yield-savings-account', 'budget-reset-when-50-30-20-breaks']
};
