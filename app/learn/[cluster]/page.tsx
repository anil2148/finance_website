...
const hubs: Record<string, HubConfig> = {
  investing: {
    ...
    resources: [
      { href: '/blog/investing-for-beginners-roadmap', title: 'Investing for beginners roadmap', description: 'A practical sequence for choosing accounts, funds, and contribution cadence.', tag: 'Start here' },
      { href: '/blog/tax-efficient-investing-playbook', title: 'Tax-efficient investing moves', description: 'Learn how account location and turnover discipline improve after-tax results.' },
  ...
  loans: {
    ...
    resources: [
      { href: '/blog/how-to-compare-personal-loan-apr', title: 'How to compare personal loan APR', description: 'Evaluate offers using APR, fees, repayment flexibility, and stress-tested payment ranges.', tag: 'Start here' },
  ...
  budgeting: {
    ...
    resources: [
      { href: '/blog/budget-reset-when-50-30-20-breaks', title: 'How to adapt the 50/30/20 rule', description: 'Use a flexible spending split that still works in high-cost or debt-heavy months.', tag: 'Start here' },
      { href: '/blog/emergency-fund-by-recovery-timeline', title: 'Emergency fund target by risk level', description: 'Pick a 3-to-6 month reserve using job stability, dependents, and replacement-time risk.' },
  ...
  'passive-income': {
    ...
    resources: [
      { href: '/blog/tax-efficient-investing-playbook', title: 'Tax-efficient investing basics', description: 'Improve after-tax outcomes with better asset location and contribution sequencing.', tag: 'Start here' },
      ...
      { href: '/blog/investing-for-beginners-roadmap', title: 'Investing roadmap for beginners', description: 'Build a repeatable first-year investing system with realistic contribution pacing.' }
    ],
    calculators: [
