...
const hubs: Record<string, HubConfig> = {
  investing: {
    ...
    resources: [
      { href: '/blog/beginner-investing-roadmap-year-one', title: 'Investing for beginners roadmap', description: 'A practical sequence for choosing accounts, funds, and contribution cadence.', tag: 'Start here' },
      { href: '/blog/tax-efficient-investing-account-location-playbook', title: 'Tax-efficient investing moves', description: 'Learn how account location and turnover discipline improve after-tax results.' },
  ...
  loans: {
    ...
    resources: [
      { href: '/blog/personal-loan-comparison-for-resilience', title: 'How to compare personal loan APR', description: 'Evaluate offers using APR, fees, repayment flexibility, and stress-tested payment ranges.', tag: 'Start here' },
      { href: '/blog/mortgage-preapproval-checklist', title: 'Mortgage preapproval checklist', description: 'Prepare documents and timeline expectations to avoid underwriting delays.' },
  ...
  budgeting: {
    ...
    resources: [
      { href: '/blog/flex-budget-reset-rules', title: 'How to adapt the 50/30/20 rule', description: 'Use a flexible spending split that still works in high-cost or debt-heavy months.', tag: 'Start here' },
      { href: '/blog/emergency-fund-target-by-recovery-time', title: 'Emergency fund target by risk level', description: 'Pick a 3-to-6 month reserve using job stability, dependents, and replacement-time risk.' },
  ...
  'passive-income': {
    ...
    resources: [
      { href: '/blog/tax-efficient-investing-account-location-playbook', title: 'Tax-efficient investing basics', description: 'Improve after-tax outcomes with better asset location and contribution sequencing.', tag: 'Start here' },
      ...
      { href: '/blog/beginner-investing-roadmap-year-one', title: 'Investing roadmap for beginners', description: 'Build a repeatable first-year investing system with realistic contribution pacing.' }
    ],
    calculators: [
